...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getFieldError(field) {
      ...
      if (isRequired && !VALIDATION_RULES.required(value)) {
      ...
      if (value.trim() !== '') {
        ...
        if ((type === 'tel' || name.toLowerCase().includes('phone')) && !VALIDATION_RULES.phone(value)) {
          return field.getAttribute('data-error-phone') || 'Please enter a valid phone number.';
        }

        if (minLength && !VALIDATION_RULES.minLength(value, parseInt(minLength, 10))) {
          return field.getAttribute('data-error-minlength') || 'This field is too short.';
        }
      }
  ...
  const animationSelector = ANIMATION_CLASSES.join(', ');
  const animatableElements = document.querySelectorAll(animationSelector);
  ...
  if (animatableElements.length > 0) {
    ...
    function applyAnimationStyles(el) {
      ...
      if (el.dataset.animateDuration) {
        el.style.transitionDuration = el.dataset.animateDuration;
      }
    }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '7dd7b9d9-0e24-4460-9073-13c0be0d3fd5',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '7dd7b9d9-0e24-4460-9073-13c0be0d3fd5';
...
/* Integration Scripts */
// setup_contact_form_emails functionality
// Email integration configured for נ.ט שערים
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '7dd7b9d9-0e24-4460-9073-13c0be0d3fd5';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '7dd7b9d9-0e24-4460-9073-13c0be0d3fd5';
